	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_IntegerConstant_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_IntegerConstant_value_feature",
								"_UI_IntegerConstant_type"),
						TermsPackage.Literals.INTEGER_CONSTANT__VALUE, true, false, false,
