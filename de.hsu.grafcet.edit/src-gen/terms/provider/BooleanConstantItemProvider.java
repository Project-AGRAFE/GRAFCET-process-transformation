	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BooleanConstant_value_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BooleanConstant_value_feature",
								"_UI_BooleanConstant_type"),
						TermsPackage.Literals.BOOLEAN_CONSTANT__VALUE, true, false, false,
